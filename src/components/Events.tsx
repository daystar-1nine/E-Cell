  ...
  return (
    <section id="events" className="relative min-h-[100dvh] w-full flex items-center py-16 sm:py-24 lg:py-32 z-10">
      <div className="container mx-auto px-4 sm:px-6 md:px-12 max-w-6xl">
                  ...
                  <div className="p-5 sm:p-7 flex-1 flex flex-col justify-between">
                    ...
                    <div className="pt-4 border-t border-hairline flex items-center justify-between mt-auto">
                      <span className="text-xs sm:text-sm text-[var(--color-primary)] font-bold flex items-center gap-1.5 group-hover:gap-2.5 transition-all">
                        View Full Event Details <ArrowRight className="w-4 h-4" />
                      </span>
        ...
        {/* Rich Event Details Spotlight Modal */}
        <AnimatePresence>
          {selectedEvent && (
            <motion.div
              initial={{ opacity: 0 }}
            ...
            >
              <motion.div
                ...
                className="w-full max-w-3xl max-h-[92vh] bg-[var(--color-surface)] border border-hairline rounded-2xl overflow-hidden flex flex-col shadow-2xl relative"
              >
                {/* Modal Header */}
                ...
                <div className="flex-1 overflow-y-auto p-5 sm:p-7 md:p-8 custom-scrollbar overscroll-contain space-y-6 bg-[var(--color-background)]">
                  {/* Poster Image */}
                  <div className="w-full rounded-xl overflow-hidden border border-hairline bg-[var(--color-surface-elevated)] shadow-sm max-h-[420px] flex items-center justify-center">
                    <img
